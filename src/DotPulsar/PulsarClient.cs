    ...
    public sealed class PulsarClient : IPulsarClient
    {
        ...
        public IProducer CreateProducer(ProducerOptions options)
        {
            ...
            var producer = new Producer(
                ...
                _processManager,
                new NotReadyChannel(),
                new AsyncLockExecutor(executor),
                stateManager
            );
        ...
        public IConsumer CreateConsumer(ConsumerOptions options)
        {
            ...
            var process = new ConsumerProcess(
                correlationId,
                stateManager,
                factory,
                consumer,
        ...
        public IReader CreateReader(ReaderOptions options)
        {
            ...
            var stateManager = new StateManager<ReaderState>(
                ReaderState.Disconnected, ReaderState.Closed, ReaderState.ReachedEndOfTopic, ReaderState.Faulted
            );
